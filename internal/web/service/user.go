...
func (u *User) GetUsers(ctx context.Context, res *[]*UserModel) {
...
func (u *User) SuspendUser(ctx context.Context, req *SetSuspendFlagRequest, res *BasicResponse) {
	sqlStmt := `UPDATE "user" SET suspended = $1 WHERE id = $2`
